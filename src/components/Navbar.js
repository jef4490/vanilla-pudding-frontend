...
//           >
//
//             <Link to={'/clients'}><MenuItem onClick={props.togglePopover}>Profile</MenuItem></Link>
//             <Link to={'/clients'}><MenuItem onClick={props.togglePopover}>My account</MenuItem></Link>
//             <Link to={'/clients'}><MenuItem onClick={props.togglePopover}>Logout</MenuItem></Link>
//           </Menu>
      ...
      <Router>
        <div className={classes.appFrame}>
          ...
          >
            ...
            <Divider />
            <List className={classes.list}>{adminMenuItems}</List>
          </Drawer>
